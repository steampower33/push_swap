...
#    Updated: 2023/09/26 21:51:18 by seunlee2         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS = src/ft_atoll.c src/ft_cmd.c src/ft_cmd_center.c src/ft_div.c src/ft_error.c src/ft_get_ab.c src/ft_rotate_ab.c \
		src/ft_set_a.c src/ft_sort.c src/ft_sort_five.c src/ft_split_arg.c src/ft_stack.c src/ft_utils.c src/push_swap.c src/ft_set_a_util.c
SRCS_BONUS = bonus/ft_atoll_bonus.c bonus/ft_cmd_bonus.c bonus/ft_cmd_center_bonus.c bonus/ft_div_bonus.c bonus/ft_error_bonus.c \
			...
			bonus/ft_split_arg_bonus.c bonus/ft_stack_bonus.c bonus/ft_utils_bonus.c bonus/push_swap_bonus.c bonus/ft_set_a_util_bonus.c
OBJS = $(SRCS:.c=.o)
